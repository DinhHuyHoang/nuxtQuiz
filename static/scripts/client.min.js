(function (f) {
  ...
  p.prototype = {
    ...
    getFingerprint() {
      const b = d.ua;
      const c = this.getScreenPrint();
      const a = this.getPlugins();
      const g = this.getFonts();
      const n = this.isLocalStorage();
      const f = this.isSessionStorage();
      const h = this.getTimeZone();
      const u = this.getLanguage();
      const m = this.getSystemLanguage();
      const e = this.isCookie();
      const C = this.getCanvasPrint();
    ...
    isMobile() {
      const b = d.ua || navigator.vendor || window.opera;
      return (
...
var deployJava = (function () {
  ...
  const p = 'codebase code name archive object width height alt align hspace vspace'
    .split(' ')
    .concat(e);
  let b;
  try {
    b = document.location.protocol.includes('http')
  ...
  var c = {
    ...
    installJRE(a, g) {
      if (this.isPluginInstalled() && this.isAutoInstallEnabled(a)) {
        ...
        if (
          ...
          this.refresh(),
            this.returnPage != null && (document.location = this.returnPage);
        return b;
      }
    ...
    installLatestJRE(a) {
      ...
      if (
        ...
        if (a == 'Netscape Family' && g.includes('win32'))
    ...
    getJPIVersionUsingMimeType() {
      for (let a = 0; a < navigator.mimeTypes.length; ++a) {
        const b = navigator.mimeTypes[a].type.match(
          /^application\/x-java-applet;jpi-version=(.*)$/
        );
        if (
          b != null &&
          ((this.firefoxJavaVersion = b[1]), this.browserName2 != 'Opera')
        )
          break;
      }
    },
    ...
    compareVersionToPattern(a, b, c, d) {
      ...
      let h = a.match('^(\\d+)(?:\\.(\\d+)(?:\\.(\\d+)(?:_(\\d+))?)?)?$');
      if (h != null) {
        let f = 0;
        a = [];
        for (var m = 1; m < h.length; ++m)
          typeof h[m] === 'string' && h[m] != '' && ((a[f] = h[m]), f++);
    ...
    getBrowser() {
      if (this.browserName == null) {
        ...
        a.includes('msie') && !a.includes('opera')
          ? (this.browserName2 = this.browserName = 'MSIE')
          : a.includes('iphone')
          ? ((this.browserName = 'Netscape Family'),
            (this.browserName2 = 'iPhone'))
          : a.includes('firefox') && !a.includes('opera')
          ? ((this.browserName = 'Netscape Family'),
          ...
          ? ((this.browserName = 'Netscape Family'),
            (this.browserName2 = 'Safari'))
          : a.includes('mozilla') && !a.includes('opera')
          ? ((this.browserName = 'Netscape Family'),
    ...
    testForMSVM() {
      if (typeof oClientCaps !== 'undefined') {
        const a = oClientCaps.getComponentVersion(
    ...
    testUsingMimeTypes(a) {
      ...
      for (let b = 0; b < navigator.mimeTypes.length; ++b) {
    ...
    testUsingPluginsArray(a) {
      ...
      for (
        let b = navigator.platform.toLowerCase(), c = 0;
        c < navigator.plugins.length;
        ++c
      )
        if (
          ((s = navigator.plugins[c].description),
          s.search(/^Java Switchable Plug-in (Cocoa)/) != -1)
        ) {
    ...
    poll() {
      this.refresh();
      const a = this.getJREs();
      this.preInstallJREList.length == 0 &&
        a.length != 0 &&
        (clearInterval(this.myInterval),
        this.returnPage != null && (location.href = this.returnPage));
      this.preInstallJREList.length != 0 &&
        a.length != 0 &&
...
var Detector = function () {
  const f = ['monospace', 'sans-serif', 'serif'];
  ...
  this.detect = function (a) {
    ...
    for (n in f) {
      ...
      d.appendChild(e);
      const v = e.offsetWidth != p[f[n]] || e.offsetHeight != b[f[n]];
      d.removeChild(e);
      c = c || v;
    }
    return c;
...
var swfobject = (function () {
  ...
  function e(a) {
    if (typeof r.addEventListener !== 'undefined')
      r.addEventListener('load', a, !1);
    else if (typeof l.addEventListener !== 'undefined')
  ...
  function p() {
    const a = l.getElementsByTagName('body')[0];
    const c = l.createElement('object');
  ...
  function b() {
    ...
    if (b > 0)
      for (let z = 0; z < b; z++) {
        let d = x[z].id;
        const h = x[z].callbackFn;
        let f = { success: !1, id: d };
        if (k.pv[0] > 0) {
          var e = m(d);
          if (e)
          ...
          A(d, !0),
            h &&
              ((d = c(d)) &&
                typeof d.SetVariable !== 'undefined' &&
                ((f.success = !0), (f.ref = d)),
              h(f));
      }
  }
  function c(a) {
    ...
    (a = m(a)) &&
      a.nodeName == 'OBJECT' &&
      (typeof a.SetVariable !== 'undefined'
        ? (b = a)
  ...
  function g(a, b, c, d) {
    ...
    if (g) {
      ...
      d =
        ...
        l.title;
      b.flashvars =
        typeof b.flashvars !== 'undefined' ? b.flashvars + ('&' + d) : d;
      k.ie &&
        k.win &&
        g.readyState != 4 &&
        ...
        ? ((b.style.display = 'none'),
          (function () {
            if (b.readyState == 4) {
              const c = m(a);
              if (c) {
                for (const d in c) typeof c[d] === 'function' && (c[d] = null);
  ...
  function q(a, b, c, d) {
    if (!k.ie || !k.mac) {
      const h = l.getElementsByTagName('head')[0];
      h &&
  ...
  var k = (function () {
    ...
    const d = c ? /win/.test(c) : /win/.test(b);
    ...
    let f = null;
    if (
      typeof t.plugins !== 'undefined' &&
      typeof t.plugins['Shockwave Flash'] === 'object'
    )
      ...
      try {
        const e = new ActiveXObject('ShockwaveFlash.ShockwaveFlash');
        e &&
  ...
  (function () {
    k.w3 &&
      (((typeof l.readyState !== 'undefined' && l.readyState == 'complete') ||
        (typeof l.readyState === 'undefined' &&
          (l.getElementsByTagName('body')[0] || l.body))) &&
        f(),
      y ||
        (typeof l.addEventListener !== 'undefined' &&
  ...
  (function () {
    k.ie &&
      ...
      window.attachEvent('onunload', function () {
        ...
        a = I.length;
        for (b = 0; b < a; b++) u(I[b]);
        for (const c in k) k[c] = null;
        k = null;
        for (const d in swfobject) swfobject[d] = null;
        swfobject = null;
      });
  })();
  return {
...
(function (f, d) {
  const e = {
    extend(a, b) {
      for (const c in b)
        'browser cpu device engine os'.includes(c) &&
          b[c].length % 2 === 0 &&
          (a[c] = b[c].concat(a[c]));
      return a;
    },
  ...
  const p = function () {
    for (var a, b = 0, c, f, g, e, p, n, r = arguments; b < r.length && !p; ) {
      ...
      if (typeof a === 'undefined')
        for (g in ((a = {}), t))
          t.hasOwnProperty(g) &&
            ((e = t[g]), typeof e === 'object' ? (a[e[0]] = d) : (a[e] = d));
          ...
          for (g = 0; g < t.length; g++)
            (n = p[++f]),
              ...
              typeof e === 'object' && e.length > 0
                ? e.length == 2
                  ? (a[e[0]] =
                      typeof e[1] === 'function' ? e[1].call(this, n) : e[1])
                  : e.length == 3
                  ? (a[e[0]] =
  ...
  var g = function (b, c) {
    ...
    let d =
      b ||
      (f && f.navigator && f.navigator.userAgent ? f.navigator.userAgent : '');
    const n = c ? e.extend(a, c) : a;
    this.getBrowser = function () {
      const a = p.apply(this, n.browser);
