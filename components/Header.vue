  ...
  <v-container fluid pa-0>
    <v-row style="background-color:#b40002;height:40px;" class="justify-center align-center white--text">
      <div style="margin-left: 16px;" class="flex-shrink-1">
        <v-btn href="http://timhieuphapluat.dongnai.gov.vn/" class="white--text" icon>
          <v-icon>home</v-icon>
        </v-btn>
      </div>
      <!-- eslint-disable-next-line -->
      <div class="subtitle text-uppercase font-weight-bold flex-grow-1 text-center" style="line-height: 2;" v-html="$sanitize(pageInfo.Title) || ''" />
    </v-row>
  </v-container>
</template>
